...
export default function SingleWorldComments() {
  return (
    <Card className="shadow-sm">
      <CardContent className="flex flex-col items-center justify-center py-16 text-center">
        ...
        <p className="text-muted-foreground mb-6 max-w-md text-sm leading-relaxed">
          We&apos;re building a community discussion feature where you can share
          your thoughts, ask questions, and connect with other adventurers.
        </p>
